...
class CustomAdaptor:
    def __init__(self, adaptor_file, mobilogger):
        self.default_dict = {
            "1": {"seq":"GGAGNNNNNGGG", "cmd":"-A"},
            "2": {"seq":"GGAGNNNNNTTT", "cmd":"-A"}, 
            "3": {"seq":"CCATCACTCAC", "cmd":"-A"}, 
            "4": {"seq":"CAACGCAGAG", "cmd":"-A"}, 
            "5" : {"seq":"AGATCTGG", "cmd":"-a"}, 
            "6": {"seq": "CAAGCAGAAGA", "cmd":"-a"}, 
            "7": {"seq": "GGCGGCCATGTT", "cmd":"-A"}, 
            "8": {"seq": "AGATCGGAAGAG", "cmd":"-A"}, 
            "9": {"seq":"CTGTCTCTTATA", "cmd":"-A"}, 
            "10": {"seq":"CACTGCTT", "cmd":"-A"}, 
